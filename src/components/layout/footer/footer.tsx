        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:pr-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="relative size-12 opacity-90 hover:opacity-100 transition-opacity">
                <Image 
                  fill
            ...
            <div className="flex gap-4">
              <Link className="p-2 rounded-full bg-foreground/5 text-muted-foreground hover:bg-brand/10 hover:text-brand transition-colors" href="#" aria-label="Website">
                <Globe className="w-4 h-4" />
              </Link>
              <Link className="p-2 rounded-full bg-foreground/5 text-muted-foreground hover:bg-brand/10 hover:text-brand transition-colors" href="mailto:tpo@radharaman.com" aria-label="Email">
                <Mail className="w-4 h-4" />
              </Link>
              <Link className="p-2 rounded-full bg-foreground/5 text-muted-foreground hover:bg-brand/10 hover:text-brand transition-colors" href="tel:+917552477777" aria-label="Phone">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><Link className="hover:text-brand transition-colors" href="/students/login">Student Portal</Link></li>
              <li><Link className="hover:text-brand transition-colors" href="/recruiters/login">Recruiter Portal</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><Link className="hover:text-brand transition-colors" href="/alumni/alumni-register">Alumni Network</Link></li>
              <li><Link className="hover:text-brand transition-colors" href="/open-drives">Open Drives</Link></li>
              <li><Link className="hover:text-brand transition-colors" href="/memories">Campus Memories</Link></li>
              <li><Link className="hover:text-brand transition-colors" href="/activities/achievements">Achievements</Link></li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-border text-xs md:text-sm text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg className="size-5 fill-current" aria-label="GitHub Profile" viewBox="0 0 24 24">
              ...
              >
                <svg className="size-5 fill-current" aria-label="LinkedIn Profile" viewBox="0 0 24 24">
