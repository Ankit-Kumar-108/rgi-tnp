    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      {viewItem && (
        ...
        >
          ...
          <div
            className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-4xl w-full overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col md:flex-row max-h-[90vh] md:max-h-none"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Content - Media */}
            <div className="w-full md:w-1/2 bg-slate-100 relative h-64 sm:h-80 md:h-auto overflow-hidden">
                <img
            ...
            {/* Modal Content - Info */}
            <div className="w-full md:w-1/2 p-5 sm:p-8 flex flex-col overflow-hidden">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-all overflow-hidden font-medium">
            <div className="p-4 sm:p-6">
                ...
                <div className="flex gap-2 mb-4 sm:mb-6 flex-wrap">
                     ...
                     {item.resumeUrl && (
                        <a href={item.resumeUrl} target="_blank" className="flex items-center gap-1.5 px-2 py-1 bg-green-50 text-green-600 text-[8px] sm:text-[9px] font-bold rounded-md hover:bg-green-100 transition-colors">
                            <FileText className="w-2.5 h-2.5 sm:w-3 sm:h-3" /> CV
                        </a>
                     )}
                </div>
                ...
                <div className="flex gap-2 sm:gap-3">
                    ...
                    onClick={() => onAction(item.id, "approve")}
                    disabled={loading === item.id}
                    className="flex-1 py-2.5 sm:py-3.5 bg-orange-500 text-white rounded-xl sm:rounded-2xl text-[11px] sm:text-xs font-bold hover:bg-orange-600 transition-all shadow-md shadow-orange-500/10 disabled:opacity-50">
