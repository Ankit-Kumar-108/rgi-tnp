                    ...
                    <div className="w-full max-w-4xl bg-card rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl overflow-hidden ring-1 ring-border flex flex-col h-[90vh]">
                        ...
                        <div className="px-6 py-4 border-t border-border bg-background flex justify-end">
                            <button
                                type="button"
                                onClick={() => setIsResumePreviewOpen(false)}
                                className="px-6 py-2.5 bg-brand text-primary-foreground rounded-lg font-bold text-sm transition-all"
                            >
                                Looks Good
                            </button>
                        </div>
                ...
                <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-background/50 backdrop-blur-sm rounded-lg  shadow-2xl shadow-brand/10 border border-brand/10 lg:h-[85vh] lg:max-h-200 mt-10 overflow-hidden">
                    ...
                    <div className="p-5 sm:p-8 md:p-10 lg:p-12 flex flex-col relative h-full lg:overflow-y-auto custom-scrollbar">
                            ...
                            <div className="space-y-1">
                                ...
                                {resumeFile ? (
                                    ...
                                    <input
                                        ...
                                        className="w-full text-xs sm:text-sm text-muted-foreground file:mr-3 sm:file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-xs sm:file:text-sm file:font-bold file:bg-brand/10 file:text-brand hover:file:bg-brand/20 cursor-pointer border border-dashed border-border p-2 rounded-lg transition-all hover:border-brand/50"
                                    />
                                )}
                            </div>
                        ...
                        <div className="mt-5 sm:mt-6 pt-4 border-t border-border relative z-10 shrink-0">
                            ...
                            <Link href="/external-students/login" className="w-full py-2.5 sm:py-3.5 rounded-lg border-2 border-brand/20 text-brand font-bold bg-transparent hover:bg-brand/5 transition-all duration-200 flex items-center justify-center gap-2 text-sm sm:text-base">Login Here</Link>
                        </div>
                    </div>
                </div>
            </main>
