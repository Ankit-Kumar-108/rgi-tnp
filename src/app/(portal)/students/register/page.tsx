                ...
                <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-background/50 backdrop-blur-sm rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl shadow-brand/10 border border-brand/10">
                    ...
                    <div className="relative hidden lg:flex flex-col justify-end p-10 xl:p-12 overflow-hidden bg-brand/5">
                        ...
                        <div className="relative z-10 text-white">
                            ...
                            <p className="text-lg text-slate-200 font-light max-w-md">Create an account to access exclusive internships, upcoming placement drives, premium training resources, and track your applications seamlessly.</p>
                    ...
                    <div className="p-6 sm:p-10 md:p-12 flex flex-col justify-center relative">
                        ...
                        <div className="mb-8 relative z-10">
                            ...
                            <p className="text-muted-foreground text-sm sm:text-base">Register as a student to access the portal.</p>
                        </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-border relative z-10">
                            ...
                            <Link href="/students/login" className="w-full py-3 sm:py-3.5 rounded-xl border-2 border-brand/20 text-brand font-bold bg-transparent hover:bg-brand/5 transition-all duration-200 flex items-center justify-center gap-2">
                                Login Here
                            </Link>
                        </div>
