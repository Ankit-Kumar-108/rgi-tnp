        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5 font-medium">Your insights shape our curriculum</p>
            </div>
          </div>
          {onClose && (
            <button
        ...
        <div className="space-y-2.5">
          ...
          <div className="relative group/textarea">
            <textarea
              ...
              placeholder="What skill is missing from the syllabus? Any suggestions for improvement?"
              rows={4}
            />
