  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-effect border-b border-brand/5 px-6 lg:px-20">
        <div className="max-w-7xl mx-auto flex h-20 items-center justify-between">
          ...
          <button className="hidden lg:block bg-brand text-white px-6 py-2.5 rounded-lg text-sm font-bold hover:bg-brand/90 transition-all shadow-lg shadow-brand/20">
            Contact Us
          </button>
        </div>
      </nav>
